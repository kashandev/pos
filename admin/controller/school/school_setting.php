...
class ControllerSchoolSchoolSetting extends HController
{

    protected function getAlias()
    {
        return 'school/school_setting';
    }
    ...
    protected function init()
    {
        ...
        $this->data['lang'] = $this->load->language('school/school_setting');
    ...
    protected function getForm()
    {
        ...
        $this->data['strValidation'] = "{
            'rules':{
                ...
                'student_account_id': {'required':true},
                'student_receivable_account_id': {'required':true},
                'late_fee_id': {'required':true},
                'late_fee_amount': {'required':true},
             },
            'ignore':[]
        }";
    ...
    protected function updateData($data) {
        ...
        $this->model['setting']->deleteBulk($this->getAlias(), array('company_id' => $this->session->data['company_id'], 'company_branch_id' => $this->session->data['company_branch_id'], 'fiscal_year_id' => $this->session->data['fiscal_year_id']));
