...
class ControllerTravelCountry extends HController {
    ...
    public function getAjaxLists() {
        $this->load->language('travel/country');
        $this->model[$this->getAlias()] = $this->load->model($this->getAlias());
        $data = array();
        $aColumns = array('action','country_name','created_at');
    ...
    protected function getForm() {
        ...
        $this->data['action_validate_name'] = $this->url->link($this->getAlias() . '/validateName', 'token=' . $this->session->data['token'] . '&country_id=' . $this->request->get['country_id']);
        $this->data['strValidation']="{
            'rules':{
                'country_name': {'required':true, 'minlength': 3, 'remote':  {url: '" . $this->data['action_validate_name'] . "', type: 'post'}},
            },
        }";
    ...
    public function validateName()
    {
        ...
        if ($country_name) {
            ...
            $arrWhere[] = "LOWER(`country_name`) = '".$country_name."'";
            $arrWhere[] = "`country_id` != '".$country_id."'";
            $where = implode(' AND ', $arrWhere);
            $row = $this->model['country']->getRow($where);
            if ($row) {
