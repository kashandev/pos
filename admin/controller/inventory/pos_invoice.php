...
class ControllerInventoryPOSInvoice extends HController {
    ...
    public function getAjaxLists() {
        ...
        $data = array();
        $aColumns = array('action', 'document_date', 'document_identity', 'partner_type','partner_name','remarks','net_amount','customer','contact_no',  'created_at', 'check_box');
...
//            $where .= " AND is_post=1";
            ...
            $html = '';
            $details = array();
            $this->model['product'] = $this->load->model('invent/product');
...
//            $where .= " AND is_post=1";
    ...
    public function printDocument() {
        ...
        if($pdf->data['company_logo'] != '') {
            ...
            $pdf->Image($image_file, 0, 0, 20, 20, '', '', 'T', false, 300, '', false, false, 0, false, false, false);
            $pdf->Ln(10);
        } else {
            // Set font
        ...
        $pdf->Ln(6);
        $pdf->Cell(50, 5, 'Invoice Value', 0, false, 'L', 0, '', 0, false, 'M', 'M');
