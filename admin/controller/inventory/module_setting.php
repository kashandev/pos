...
//        }";
        ...
        $this->data['strValidation'] = "{
            'rules':{
                ...
                'additional_sale_tax_account_id' : {'required':true},
                'income_tax_account_id' : {'required':true},
                'custom_duty_account_id' : {'required':true},
                'additional_custom_duty_account_id' : {'required':true},
                'regulatory_duty_account_id' : {'required':true},
                'freight_account_id' : {'required':true},
                'contra_account_id' : {'required':true}
             },
        }";
