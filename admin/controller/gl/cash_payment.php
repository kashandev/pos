...
//        d(array($filter,$product_stock),true);
    ...
    public function printDocument() {
        ...
        $this->model['ledger'] = $this->load->model('gl/ledger');
        $LedgerDetails = $this->model['ledger']->getPurchaseLedger(12,$cash_payment_id);
...
//        $pdf->Cell(190, 7, 'CASH PAYMENT VOUCHER', 'T,B', false, 'C', 1, '', 1);
//        $pdf->ln(10);
//
...
//        $pdf->Cell(24, 8, 'Amount', 1, false, 'C', 1, '', 1);
        ...
        $pdf->Output('Cash Payment - '.$voucher['document_identity'].'.pdf', 'I');
    ...
    public function Header() {
        ...
        */
        ...
        if ($this->is_ledger == 0) {
            ...
            $this->Cell(190, 7, 'CASH PAYMENT VOUCHER', 'T,B', false, 'C', 1, '', 1);
            $this->ln(10);
            ...
            $this->SetFont('times','', 8);
            $this->SetFillColor(255,255,255);
            $this->MultiCell(160, 8, html_entity_decode($this->data['remarks']), 0, 'L', 1, 0, '', '', true, 0, false, true, 50, 'T');
...
//
            ...
            $this->Cell(105, 7, 'Accounts Description', 'T,B', false, 'L', 1, '', 1);
            $this->Cell(30, 7, 'Debit', 'T,B', false, 'C', 1, '', 1);
            $this->Cell(30, 7, 'Credit', 'T,B', false, 'C', 1, '', 1);
