                            ...
                            <form action="<?php echo $action_delete; ?>" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <th align="center"><?php echo $lang['preregistration_date']; ?></th>
                                        <th align="center"><?php echo $lang['preregistration_no']; ?></th>
                                        ...
                                        <th align="center"><?php echo $lang['interview_time']; ?></th>
                                        <th align="center"><?php echo $lang['for_class']; ?></th>
                                        <th align="center"><?php echo $lang['for_academic_year']; ?></th>
