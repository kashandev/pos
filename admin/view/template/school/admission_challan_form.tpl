                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="hidden" id="partner_type_id" name="partner_type_id" value="<?php echo $partner_type_id; ?>" class="form-control"/>
                                            <input type="hidden" id="partner_id" name="partner_id" value="<?php echo $partner_id; ?>" class="form-control"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="due_month" name="due_month" value="<?php echo $due_month; ?>" class="form-control dtpMonth"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label><span class="required">*</span>&nbsp;<?php echo $lang['last_date']; ?></label>
                                            <input type="text" id="last_date" name="last_date" value="<?php echo $last_date; ?>" class="form-control dtpDate"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label><span class="required">*</span>&nbsp;<?php echo $lang['validity_date']; ?></label>
                                            <input type="text" id="validity_date" name="validity_date" value="<?php echo $validity_date; ?>" class="form-control dtpDate"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="fee_month" name="fee_month" value="" class="form-control dtpMonth"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
<script type="text/javascript" src="dist/js/pages/school/admission_challan.js"></script>
