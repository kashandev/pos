                        ...
                        <div class="box-body">
                            <form action="<?php echo $action_delete; ?>" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center">
                                    <thead>
                                    <tr>
                                        <th aligns="center"><?php echo $lang['action']; ?></th>
                                        <th align="center"><?php echo $lang['slot_date']; ?></th>
                                        <th align="center"><?php echo $lang['time_from']; ?></th>
                                        <th align="center"><?php echo $lang['time_to']; ?></th>
                                        <th align="center"><?php echo $lang['slot_interval']; ?></th>
                                        <th align="center"><?php echo $lang['created_at']; ?></th>
                                        <th aligns="center"><?php echo $lang['select']; ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
