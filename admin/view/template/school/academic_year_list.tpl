                            ...
                            <form action="#" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <th align="center"><?php echo $lang['title']; ?></th>
                                        <th align="center"><?php echo $lang['from_date']; ?></th>
                                        <th align="center"><?php echo $lang['to_date']; ?></th>
                                        <th align="center"><?php echo $lang['created_at']; ?></th>
                                        <th aligns="center"><?php echo $lang['delete']; ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
