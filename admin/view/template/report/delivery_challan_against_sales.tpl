...
<div class="wrapper">
        ...
        <section class="content-header">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="javascript:void(0);" onclick="printExcelReport();">
                            <i class="fa fa-print"></i>
                            &nbsp; Excel
                        </a>
                    </div>
                        ...
                        <div class="box-header box-default">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $lang[entry_challan_type]; ?></label>
                                            <select class="form-control" name="challan_type" id="challan_type" >
                                                <option value="">&nbsp;</option>
                                                <option value="GST"><?php echo $lang[text_gst]; ?></option>
                                                <option value="Non GST"><?php echo $lang[text_non_gst]; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="group_by" id="group_by_id" >
                                                <option value="">&nbsp;</option>
                                                <option value="with_invoice"><?php echo $lang[text_with_invoice]; ?></option>
                                                <option value="without_invoice"><?php echo $lang[text_without_invoice]; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript" src="../admin/view/js/report/delivery_challan_against_sales.js"></script>
    <script type="text/javascript">
        var $UrlPrint = '<?php echo $href_print_report; ?>';
        var $UrlExportExcel = '<?php echo $href_export_excel_report; ?>';
