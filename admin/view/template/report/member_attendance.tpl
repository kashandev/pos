...
<div class="wrapper">
                                                ...
                                                <div class="col-md-3">
                                                    <div id="_available_column" class="panel panel-default">
                                                        ...
                                                        <div class="panel-body list-group" style="height: 350px; overflow-y: auto;">
                                                            <a class="list-group-item" data-column_name="sport_name" data-display_name="Sport" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Sport</p>
                                                            </a>
                                                            <a class="list-group-item" data-column_name="attendance_date" data-display_name="Attendance Date" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Attendance Date</p>
                                                            </a>
                                                            <a class="list-group-item" data-column_name="event_day" data-display_name="Attendance Day" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Attendance Day</p>
                                                            </a>
                                                            ...
                                                            <a class="list-group-item" data-column_name="mobile_no" data-display_name="Member Mobile No." href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Member Mobile No.</p>
                                                            </a>
                                                            <a class="list-group-item" data-column_name="status" data-display_name="Status" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Status</p>
                                                            </a>
                                                            <a class="list-group-item" data-column_name="total_present" data-display_name="Total Present" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Total Present</p>
                                                            </a>
                                                            <a class="list-group-item" data-column_name="total_absent" data-display_name="Total Absent" href="javascript:void(0);">
                                                                <span onclick="fnAddToList(this);" class="badge bg-yellow"><i class="fa fa-arrow-right"></i></span>
                                                                <p class="list-group-item-text">Total Absent</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript" src="dist/js/pages/report/member_attendance.js"></script>
    <script type="text/javascript">
        var $UrlFilterReport = '<?php echo $action_filter_member_attendance; ?>';
        var $UrlPdfReport = '<?php echo $action_pdf_member_attendance; ?>';
        var $UrlExcelReport = '<?php echo $action_excel_member_attendance; ?>';

        var $UrlSaveReport = '<?php echo $action_save_member_attendance; ?>';
        var $UrlRemoveReport = '<?php echo $action_remove_member_attendance; ?>';
        var $UrlLoadReport = '<?php echo $action_load_member_attendance; ?>';
    </script>
