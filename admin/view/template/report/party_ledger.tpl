...
<div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="pull-right">
                        ...
                        <a class="btn btn-success" href="javascript:void(0);" onclick="printDetailExcel();"><i class="fa fa-print"></i>&nbsp; Print Detail
                                    </a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input required="true" type="text" id="date_from" name="date_from" value="<?php echo $date_from; ?>" class="form-control dtpDate"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><span class="required">*</span>&nbsp;<?php echo $lang['to_date']; ?></label>
                                            <input required="true" type="text" id="date_to" name="date_to" value="<?php echo $date_to; ?>" class="form-control dtpDate"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <div class="pull-right">
                                    ...
                                    <a class="btn btn-success" href="javascript:void(0);" onclick="printExcel();"><i class="fa fa-print"></i>&nbsp;Print Summary
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="../admin/view/js/report/party_ledger.js"></script>
    ...
    <script type="text/javascript">
        ...
        var $UrlPrintDetailExcel = '<?php echo $href_print_detail_excel; ?>';
