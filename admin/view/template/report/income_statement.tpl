...
<div class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo $lang[entry_from_date]; ?><span class="required">*</span></label>
                                    <input type="text" name="date_from" id="date_from" value="<?php echo $date_from; ?>" class="form-control dtpDate" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo $lang[entry_to_date]; ?><span class="required">*</span></label>
    ...
    <script type="text/javascript" src="../admin/view/js/report/income_statement.js"></script>
