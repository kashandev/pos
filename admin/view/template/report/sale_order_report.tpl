...
<div class="wrapper">
                        ...
                        <div class="box-header box-default">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date_from" id="date_from" value="<?php echo $date_from; ?>" class="form-control dtpDate" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <label for="salesman_id" class="error" style="display: none;"></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="group_by" id="group_by_id" >
                                                ...
                                                <option value="partner"><?php echo $lang[column_customer]; ?></option>
                                                <option value="salesman"><?php echo $lang[text_salesman]; ?></option>
    ...
    <script type="text/javascript" src="../admin/view/js/report/sale_order_report.js"></script>
