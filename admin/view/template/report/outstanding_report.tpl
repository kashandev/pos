...
<div class="wrapper">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="partner_category_id" name="partner_category_id">
                                                ...
                                                <option value="<?php echo $partner_category['partner_category_id']; ?>"><?php echo $partner_category['name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div> -->
    ...
    <script type="text/javascript" src="../admin/view/js/report/outstanding_report.js"></script>
    ...
    <script type="text/javascript">
        ...
        var $UrlGetPartnerCategory = '<?php echo $href_get_partner; ?>';
