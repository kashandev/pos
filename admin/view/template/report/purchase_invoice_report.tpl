...
<div class="wrapper">
                                ...
                                <div class="col-md-12">
                                    <table id="tblReport" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <th class="center"><?php echo $lang['container_no']; ?></th> -->
                                            <!-- <th class="center"><?php echo $lang['batch_no']; ?></th> -->
                                            <th class="center"><?php echo $lang['product']; ?></th>
                                            <th class="center"><?php echo $lang['qty']; ?></th>
                                            <!-- <th class="center"><?php echo $lang['cubic_feet']; ?></th> -->
    ...
    <script type="text/javascript" src="../admin/view/js/report/purchase_invoice.js"></script>
