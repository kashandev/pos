                        ...
                        <div class="box-body">
                            <form action="#" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <td aligns="center"><?php echo $lang['column_action']; ?></td>
                                        <td align="center"><?php echo $lang['column_name']; ?></td>
                                        <td align="center"><?php echo $lang['column_currency_code']; ?></td>
                                        <td align="center"><?php echo $lang['column_created_at']; ?></td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
