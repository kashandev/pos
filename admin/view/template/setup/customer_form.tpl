                        ...
                        <form  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>&nbsp;<?php echo $lang['customer_code']; ?></label>
                                        <input class="form-control" readonly type="text" name="customer_code" id="customer_code" value="<?php echo $customer_code; ?>" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                <div class="form-group">
                                        <label><?php echo $lang['poc_name']; ?></label>
                                        <input class="form-control" type="text" name="poc_name" value="<?php echo $poc_name; ?>" />
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label><span class="required">*</span>&nbsp;<?php echo $lang['outstanding_account']; ?>&nbsp;&nbsp;(Use Account "Receivable From Customer")</label>
                                        ...
                                        <label for="outstanding_account_id" class="error" style="display: none;"><?php echo $error['receivable_account']; ?></label>
                                    </div>
                                </div>
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
...
<!--                                 <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><span class="required">*</span>&nbsp;<?php echo $lang['advance_account']; ?>&nbsp;&nbsp;(Use Account "Advance From Customer")</label>
