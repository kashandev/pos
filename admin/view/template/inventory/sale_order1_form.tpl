            ...
            <div class="col-lg-12">
                ...
                <table id="tblSaleOrder" class="table table-striped table-bordered" style="width: 2000px !important;max-width: 2000px !important;">
                    ...
                    <tr align="center" data-row_id="H">
                        ...
                        <td style="width: 150px;"><?php echo $lang['stock_qty']; ?></td>
                    ...
                    <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                        ...
                        <td>
                            <input type="text" class="form-control fPDecimal" name="sale_order_details[<?php echo $grid_row; ?>][stock_qty]" id="sale_order_detail_stock_qty_<?php echo $grid_row; ?>" value="<?php echo $detail['stock_qty']; ?>" />
                        </td>
                        <td>
