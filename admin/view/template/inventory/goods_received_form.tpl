        ...
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" value="<?php echo $goods_received_id; ?>" name="document_id" id="document_id" />
                            ...
                            <div class="col-lg-12 ">
                                <div class="table-responsive form-group">
                                    ...
                                    <tr align="center">
                                        ...
                                        <td style="width: 120px;"><?php echo $lang['ref_document_no']; ?></td>
                                    ...
                                    <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <select onchange="getProductById(this);" class="form-control select2 product code1" id="goods_received_detail_product_id_<?php echo $grid_row; ?>" name="goods_received_details[<?php echo $grid_row; ?>][product_id]" >
                                                    <option value="">&nbsp;</option>
...
<script type="text/javascript" src="../admin/view/js/inventory/goods_received.js"></script>
