...
<div class="wrapper">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                                ...
                                <input type="hidden" value="<?php echo $branch_stock_transfer_id; ?>" name="document_id" id="document_id" />
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <table id="tblBranchStockTransfer" class="table table-striped table-bordered table-hover">
                                            <thead>
                                            <tr align="center">
                                                ...
                                                <td style="width: 150px;"><?php echo $lang['company_branch']; ?></td>
                                            ...
                                            <tbody >
                                            <?php $grid_row = 0; ?>
                                            <?php foreach($branch_stock_transfer_details as $detail): ?>
                                            <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                ...
                                                <td>
                                                    <input onchange="getProductByCode(this);" type="text" class="form-control" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][product_code]" id="branch_stock_transfer_detail_product_code_<?php echo $grid_row; ?>" value="<?php echo $detail['product_code']; ?>" />
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <select onchange="getProductById(this);" class="form-control select2 product" id="branch_stock_transfer_detail_product_id_<?php echo $grid_row; ?>" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][product_id]" >
                                                            <option value="">&nbsp;</option>
                                                            <option value="<?php echo $detail['product_id']; ?>" selected="selected"><?php echo $detail['product_name']; ?></option>
                                                        </select>
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-default btn-flat QSearchProduct" id="QSearchProduct" type="button" data-element="branch_stock_transfer_detail_product_id_<?php echo $grid_row; ?>" data-field="product_id">
                                                ...
                                                <td>
                                                    <select onchange="getWarehouseByBranchId(this);" class="form-control select2" id="branch_stock_transfer_detail_to_company_branch_id_<?php echo $grid_row; ?>" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][to_company_branch_id]" >
                                                        <option value="">&nbsp;</option>
                                                        <?php foreach($company_branchs as $company_branch): ?>
                                                        <option value="<?php echo $company_branch['company_branch_id']; ?>" <?php echo ($company_branch['company_branch_id']==$detail['to_company_branch_id']?'selected="true"':'');?>><?php echo $company_branch['name']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select  class="form-control select2" id="branch_stock_transfer_detail_warehouse_id_<?php echo $grid_row; ?>" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][warehouse_id]" >
                                                        <?php echo $detail['warehouse_id']; ?>
                                                        <!--<option value="">&nbsp;</option>
                                                        <?php foreach($warehouses as $warehouse): ?>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][unit]" id="branch_stock_transfer_detail_unit_<?php echo $grid_row; ?>" value="<?php echo $detail['unit']; ?>" readonly="true" />
                                                    <input type="hidden" class="form-control" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][unit_id]" id="branch_stock_transfer_detail_unit_id_<?php echo $grid_row; ?>" value="<?php echo $detail['unit_id']; ?>" />
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][stock_qty]" id="branch_stock_transfer_detail_stock_qty_<?php echo $grid_row; ?>" value="<?php echo $detail['stock_qty']; ?>" readonly="true" />
                                                    <input type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][cog_rate]" id="branch_stock_transfer_detail_cog_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['cog_rate']; ?>" readonly />
                                                </td>
                                                <td>
                                                    <input onchange="calculateRowTotal(this);" type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][qty]" id="branch_stock_transfer_detail_qty_<?php echo $grid_row; ?>" value="<?php echo $detail['qty']; ?>" />
                                                    <input type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][cog_amount]" id="branch_stock_transfer_detail_cog_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['cog_amount']; ?>" readonly/>
                                                </td>
                                                <td>
                                                    <input type="hidden" class="form-control fPDecimal" id="branch_stock_transfer_detail_exist_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['cog_rate']; ?>"/>
                                                    <input onchange="calculateRowTotal(this);" type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][rate]" id="branch_stock_transfer_detail_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['rate']; ?>"  readonly="true" />

                                                </td>
                                                <td>
                                                    <input onchange="calculateRowTotal(this);" type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][amount]" id="branch_stock_transfer_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" readonly />
                                                </td>
                                                <td><a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a></td>
                                            </tr>
                                            <?php $grid_row++; ?>
    ...
    <script type="text/javascript" src="../admin/view/js/inventory/branch_stock_transfer.js"></script>
    ...
    //        }
        ...
        <?php if($this->request->get['branch_stock_transfer_id']): ?>
