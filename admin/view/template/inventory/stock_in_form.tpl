    ...
    <div class="box">
        ...
        <div class="box-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <input type="hidden" value="<?php echo $stock_in_id; ?>" name="document_id" id="document_id" />
                <div class="row">
                    <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="tblStockIn" class="table table-striped table-bordered">
                            <thead>
                            <tr align="center">
                            ...
                            <tbody >
                            <?php $stock_row = count($stock_in_details); $stock_row_desc = count($stock_in_details)-1;?>
                            <?php foreach($stock_in_details as $detail): ?>
                            <tr id="stock_row_<?php echo $stock_row_desc; ?>" data-stock_row="<?php echo $stock_row_desc; ?>">
                                ...
                                <td>
                                    <input class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_product_code" name="stock_in_details[<?php echo $stock_row_desc; ?>][product_code]" value="<?php echo $detail['product_code']; ?>" readonly />
                                </td>
                                <td>
                                    <input class="form-control" type="hidden" id="stock_in_detail_<?php echo $stock_row_desc; ?>_product_id" name="stock_in_details[<?php echo $stock_row_desc; ?>][product_id]" value="<?php echo $detail['product_id']; ?>" />
                                    <input class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_product_name" name="stock_in_details[<?php echo $stock_row_desc; ?>][product_name]" value="<?php echo $detail['product_name']; ?>" readonly />
                                </td>
                                <td>
                                    <input class="form-control" type="hidden" id="stock_in_detail_<?php echo $stock_row_desc; ?>_unit_id" name="stock_in_details[<?php echo $stock_row_desc; ?>][unit_id]" value="<?php echo $detail['unit_id']; ?>" />
                                    <input class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_unit" name="stock_in_details[<?php echo $stock_row_desc; ?>][unit]" value="<?php echo $detail['unit']; ?>" readonly />
                                </td>
                                <td>
                                    <input onchange="calculateCOGAmount(<?php echo $stock_row_desc; ?>);" class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_qty" name="stock_in_details[<?php echo $stock_row_desc; ?>][qty]" value="<?php echo $detail['qty']; ?>" />
                                </td>
                                <td>
                                    <input onchange="calculateCOGAmount(<?php echo $stock_row_desc; ?>);" class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_cog_rate" name="stock_in_details[<?php echo $stock_row_desc; ?>][cog_rate]" value="<?php echo $detail['cog_rate']; ?>" />
                                </td>
                                <td>
                                    <input class="form-control" type="text" id="stock_in_detail_<?php echo $stock_row_desc; ?>_cog_amount" name="stock_in_details[<?php echo $stock_row_desc; ?>][cog_amount]" value="<?php echo $detail['cog_amount']; ?>" readonly/>
                                </td>
                                <td><a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a></td>
                            </tr>
                            <?php $stock_row_desc--; ?>
