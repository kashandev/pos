                        ...
                        <div class="box-body">
                            <form  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                                <div class="form-group">
                                    ...
                                    <input id="code" class="form-control" readonly type="text" name="code" value="<?php echo $code; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><span class="required">*</span>&nbsp;<?php echo $lang['name']; ?></label>
                                    <input id="name" class="form-control" type="text" id="name" name="name" value="<?php echo $name; ?>" />
                                </div>
                                <div class="form-group">
