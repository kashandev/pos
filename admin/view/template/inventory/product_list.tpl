                        ...
                        <div class="dropdown-menu row" style="z-index: 1050;">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="partner_category_id" id="product_category_id" class="form-control">
                                        <option value="">&nbsp;</option>
                                        <?php foreach($product_categorys as $product_category): ?>
                                        <option value="<?php echo $product_category['product_category_id']; ?>" <?php echo ($product_category['product_category_id']==$product_category_id?'selected="true"':'');?>><?php echo $product_category['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_sub_category_id" id="product_sub_category_id" class="form-control">
                                        ...
                                        <option value="<?php echo $product_sub_category['product_sub_category_id']; ?>" <?php echo ($product_sub_category['product_sub_category_id']==$product_sub_category_id?'selected="true"':'');?>><?php echo $product_sub_category['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand_id" id="brand_id" class="form-control">
                                        ...
                                        <option value="<?php echo $brand['brand_id']; ?>" <?php echo ($brand['brand_id']==$brand_id?'selected="true"':'');?>><?php echo $brand['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                        ...
                        <div class="box-body">
                            <form action="#" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <td align="center" style="width: 3%;"><?php echo $lang['action']; ?></td>
                                        <td align="center" style="width: 3%"><?php echo $lang['product_category']; ?></td>
                              <!--           <td align="center"><?php echo $lang['product_sub_category']; ?></td>
                                        <td align="center"><?php echo $lang['brand']; ?></td> -->
                                        <td align="center" style="width: 4%;"><?php echo $lang['code']; ?></td>
                                        <td align="center" style="width: 9%;"><?php echo $lang['name']; ?></td>
                                        <!-- <td align="center"><?php echo $lang['unit']; ?></td> -->
                                        <td align="center" style="width: 3%"><?php echo $lang['cost_price']; ?></td>
                                        <td align="center" style="width: 3%"><?php echo $lang['sale_price']; ?></td>
                                        <td align="center" style="width: 5%"><?php echo $lang['created_at']; ?></td>
                                        <td align="center" style="width: 1%"><?php echo $lang['delete']; ?></td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
...
<script type="text/javascript">
    ...
    $(document).on('click','#btn_filter_apply',function() {
        ...
        if($product_sub_category_id != '') {
            $url += "&product_sub_category_id="+$product_sub_category_id;
        }
