                ...
                <div class="box-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label><span class="required">*</span>&nbsp;<?php echo $lang['supplier_name']; ?></label>
                                    <select class="form-control" id="partner_id" name="partner_id">
                                        <option value="">&nbsp;</option>
                                        <?php foreach($suppliers as $supplier): ?>
                                        <option value="<?php echo $supplier['supplier_id']; ?>" <?php echo ($partner_id == $supplier['supplier_id']?'selected="selected"':''); ?>><?php echo $supplier['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript" src="../admin/view/js/inventory/stock_update.js"></script>
