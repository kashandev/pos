                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                                ...
                                <input type="hidden" value="<?php echo $pos_invoice_id; ?>" name="document_id" id="document_id" />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive form-group">
                                            <table id="tblPOSInvoice" class="table table-striped table-bordered">
                                                ...
                                                <tbody >
                                                <?php foreach($pos_invoice_details as $row_id => $detail): ?>
                                                <tr id="row_id_<?php echo $row_id; ?>" data-row_id="<?php echo $row_id; ?>" data-product_id="<?php echo $detail['product_id']; ?>">
                                                    ...
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][product_code]" id="pos_invoice_detail_<?php echo $row_id; ?>_product_code" value="<?php echo $detail['product_code']; ?>" readonly/>
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][product_name]" id="pos_invoice_detail_<?php echo $row_id; ?>_product_name" value="<?php echo $detail['product_name']; ?>" readonly/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][product_id]" id="pos_invoice_detail_<?php echo $row_id; ?>_product_id" value="<?php echo $detail['product_id']; ?>" readonly/>
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateAmount(<?php echo $row_id; ?>);" type="text" style="min-width: 100px;" class="form-control text-right" name="pos_invoice_details[<?php echo $row_id; ?>][qty]" id="pos_invoice_detail_<?php echo $row_id; ?>_qty" value="<?php echo $detail['qty']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][unit]" id="pos_invoice_detail_<?php echo $row_id; ?>_unit" value="<?php echo $detail['unit']; ?>" readonly/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][unit_id]" id="pos_invoice_detail_<?php echo $row_id; ?>_unit_id" value="<?php echo $detail['unit_id']; ?>" readonly/>
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][stock]" id="pos_invoice_detail_<?php echo $row_id; ?>_stock" value="<?php echo $detail['stock']; ?>" readonly/>
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control text-right" name="pos_invoice_details[<?php echo $row_id; ?>][rate]" id="pos_invoice_detail_<?php echo $row_id; ?>_rate" value="<?php echo $detail['rate']; ?>" readonly/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][cog_rate]" id="pos_invoice_detail_<?php echo $row_id; ?>_cog_rate" value="<?php echo $detail['cog_rate']; ?>" readonly/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][cog_amount]" id="pos_invoice_detail_<?php echo $row_id; ?>_cog_amount" value="<?php echo $detail['cog_amount']; ?>" readonly/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control fPDecimal" name="pos_invoice_details[<?php echo $row_id; ?>][amount]" id="pos_invoice_detail_<?php echo $row_id; ?>_amount" value="<?php echo $detail['amount']; ?>" readonly="true" />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateDiscountAmount(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal text-right" name="pos_invoice_details[<?php echo $row_id; ?>][discount_percent]" id="pos_invoice_detail_<?php echo $row_id; ?>_discount_percent" value="<?php echo $detail['discount_percent']; ?>" readonly />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateAmount(<?php echo $row_id; ?>);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="pos_invoice_details[<?php echo $row_id; ?>][discount_amount]" id="pos_invoice_detail_<?php echo $row_id; ?>_discount_amount" value="<?php echo $detail['discount_amount']; ?>" readonly />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control fPDecimal text-right" name="pos_invoice_details[<?php echo $row_id; ?>][gross_amount]" id="pos_invoice_detail_<?php echo $row_id; ?>_gross_amount" value="<?php echo $detail['gross_amount']; ?>" readonly="true"/>
                                                        <input type="hidden" style="min-width: 100px;" class="form-control" name="pos_invoice_details[<?php echo $row_id; ?>][total_amount]" id="pos_invoice_detail_<?php echo $row_id; ?>_total_amount" value="<?php echo $detail['total_amount']; ?>" readonly/>
                                                    </td>
                                                    <td><a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a></td>
                                                </tr>
                                                <?php endforeach; ?>
                                                <?php $row_id = count($pos_invoice_details); ?>
                                                </tbody>
                                                <tfoot>
                                                </tfoot>
                                            </table>
