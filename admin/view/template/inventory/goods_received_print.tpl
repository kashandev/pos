...
<page backtop="30mm" backbottom="14mm" backleft="1%" backright="1%" style="font-size: 12pt">
    ...
    <div>
        ...
        <table class="page_body" style="margin-top: 15px;">
            <thead>
            <tr>
                <th style="width: 20%;"><?php echo $lang['warehouse']; ?></th>
                <th style="width: 10%;"><?php echo $lang['product_code']; ?></th>
                <th style="width: 20%;"><?php echo $lang['name']; ?></th>
                <th style="width: 10%;"><?php echo $lang['quantity']; ?></th>
                <th style="width: 15%;"><?php echo $lang['unit']; ?></th>
                <th style="width: 10%;"><?php echo $lang['rate']; ?></th>
                <th style="width: 15%;"><?php echo $lang['net_amount']; ?></th>
            </tr>
            </thead>
            <tbody>
            <?php $total_amount = 0; ?>
            ...
            <tr>
                <td><?php echo $detail['warehouse']; ?></td>
            ...
            <?php endforeach; ?>
            <tr>
                <td colspan="5"><?php echo Number2Words($total_amount); ?></td>
