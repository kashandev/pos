...
<div class="wrapper">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                                ...
                                <input type="hidden" value="<?php echo $sale_return_id; ?>" name="document_id" id="document_id" />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ref_document_type_id" id="ref_document_type_id">
                                                <option value="">&nbsp;</option>
                                                <!-- <option value="2"><?php echo $lang['sale_invoice']; ?></option> -->
                                                <option value="39"><?php echo $lang['sale_invoice']; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive form-group">
                                            <table id="tblSaleReturn" class="table table-striped table-bordered" style="width: 2000px !important;max-width: 5000px !important;">
                                                <thead>
                                                <tr align="center">
                                                    <td style="width: 4%;"><a id="btnAddGrid" title="Add" href="javascript:void(0);"><i class="fa fa-plus"></i></a></td>
                                                ...
                                                <tbody >
                                                <?php foreach($sale_return_details as $grid_row => $detail): ?>
                                                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                    ...
                                                    <td>
                                                        <input type="hidden" name="sale_return_details[<?php echo $grid_row; ?>][ref_document_type_id]" id="sale_return_detail_ref_document_type_id_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_type_id']; ?>" />
                                                        <input type="hidden" name="sale_return_details[<?php echo $grid_row; ?>][ref_document_identity]" id="sale_return_detail_ref_document_identity_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_identity']; ?>" />
                                                        <a target="_blank" href="<?php echo $detail['href']; ?>"><?php echo $detail['ref_document_identity']; ?></a>
                                                    </td>
                                                    <td>
                                                        <input onchange="getProductByCode(this);" type="text" style="min-width: 100px;" class="form-control" name="sale_return_details[<?php echo $grid_row; ?>][product_code]" id="sale_return_detail_product_code_<?php echo $grid_row; ?>" value="<?php echo $detail['product_code']; ?>" />
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <select onchange="getProductById(this);" class="form-control select2" id="sale_return_detail_product_id_<?php echo $grid_row; ?>" name="sale_return_details[<?php echo $grid_row; ?>][product_id]" >
                                                                <option value="">&nbsp;</option>
                                                            ...
                                                            <span class="input-group-btn ">
                                                                <button class="btn btn-default btn-flat QSearchProduct" id="QSearchProduct" type="button" data-element="sale_return_detail_product_id_<?php echo $grid_row; ?>" data-field="product_id">
                                                    ...
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="sale_return_details[<?php echo $grid_row; ?>][description]" id="sale_return_detail_description_<?php echo $grid_row; ?>" value="<?php echo $detail['product_name']; ?>" />
                                                    </td>
                                                    <?php if( $isEdit == 1 ): ?>
                                                    <script>
                                                        $(window).load(function(){
                                                            setTimeout(function(){
                                                                validateWarehouseStock($('#sale_return_detail_stock_qty_<?php echo $grid_row; ?>'), true);
                                                            }, 1000);
                                                        });
                                                    </script>
                                                    <?php endif; ?>
                                                    <td>
                                                        <select onchange="validateWarehouseStock(this);" class="form-control select2" id="sale_return_detail_warehouse_id_<?php echo $grid_row; ?>" name="sale_return_details[<?php echo $grid_row; ?>][warehouse_id]" >
                                                            <option value="">&nbsp;</option>
                                                    ...
                                                    <td>
                                                        <input style="min-width: 100px;" type="text" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][stock_qty]" id="sale_return_detail_stock_qty_<?php echo $grid_row; ?>" value="<?php echo $detail['stock_qty']; ?>" readonly />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateRowTotal(this);" style="min-width: 100px;" type="text" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][qty]" id="sale_return_detail_qty_<?php echo $grid_row; ?>" value="<?php echo $detail['qty']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="sale_return_details[<?php echo $grid_row; ?>][unit]" id="sale_return_detail_unit_<?php echo $grid_row; ?>" value="<?php echo $detail['unit']; ?>" readonly="true" />
                                                        <input type="hidden" class="form-control" name="sale_return_details[<?php echo $grid_row; ?>][unit_id]" id="sale_return_detail_unit_id_<?php echo $grid_row; ?>" value="<?php echo $detail['unit_id']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateRowTotal(this);" style="min-width: 100px;" type="text" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][rate]" id="sale_return_detail_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['rate']; ?>" />
                                                        <input type="hidden" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][cog_rate]" id="sale_return_detail_cog_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['cog_rate']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][amount]" id="sale_return_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" readonly="true" />
                                                        <input type="hidden" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][cog_amount]" id="sale_return_detail_cog_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['cog_amount']; ?>" readonly="true" />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateDiscountAmount(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][discount_percent]" id="sale_return_detail_discount_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['discount_percent']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateDiscountPercent(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][discount_amount]" id="sale_return_detail_discount_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['discount_amount']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][gross_amount]" id="sale_return_detail_gross_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['gross_amount']; ?>" readonly="true"/>
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateTaxAmount(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][tax_percent]" id="sale_return_detail_tax_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['tax_percent']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input onchange="calculateTaxPercent(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][tax_amount]" id="sale_return_detail_tax_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['tax_amount']; ?>" />
                                                    </td>
                                                    <td>
                                                        <input type="text" style="min-width: 100px;" class="form-control fPDecimal" name="sale_return_details[<?php echo $grid_row; ?>][total_amount]" id="sale_return_detail_total_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['total_amount']; ?>" readonly="true" />
                                                    </td>
                                                    <!--<td>
                                                        <input type="text" style="min-width: 100px;" class="form-control" name="sale_return_details[<?php echo $grid_row; ?>][remarks]" id="sale_return_detail_remarks_<?php echo $grid_row; ?>" value="<?php echo $detail['remarks']; ?>" />
                                                    </td>-->
                                                    <td>
                                                        <a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>
                                                        <a title="Add" class="btn btn-xs btn-primary btnAddGrid" id="btnAddGrid" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
                                                ...
                                                <?php endforeach; ?>
                                                <?php $grid_row = count($sale_return_details); ?>
                                                </tbody>
                                                <tfoot>
                                                </tfoot>
                                            </table>
                                ...
                                <div class="row">
                                    <div class="col-sm-offset-6 col-sm-3">
                                        <div class="form-group">
                                            <label><?php echo $lang['cash_returned']; ?></label>
                                            <input type="text" id="cash_returned" name="cash_returned" value="<?php echo $cash_returned; ?>" class="form-control fDecimal" placeholder="0.00" onchange="calculateTotal();" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
    ...
    <script type="text/javascript" src="../admin/view/js/inventory/sale_return.js"></script>
    ...
    <script>
        ...
        <?php if($this->request->get['sale_return_id']): ?>
