    ...
    <div>
        ...
        <table class="page_body" style="margin-top: 15px;">
            ...
            <tr>
                ...
                <th style="width: 30%;"><?php echo $lang['product_code']; ?></th>
            ...
            <tr>
                <td colspan="2">&nbsp;</td>
                <td><strong><?php echo $lang['total_qty']; ?></strong></td>
                <td style="text-align: right;"><strong><?php echo number_format($total_qty,2); ?></strong></td>
            </tr>
            </tbody>
        </table>
