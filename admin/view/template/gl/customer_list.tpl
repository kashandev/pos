                    ...
                    <div class="col-lg-12">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $column_customer_group; ?></td>
                                <td align="center"><?php echo $column_credit_limit; ?></td>
                                <td align="left"><?php echo $column_status; ?></td>
                            ...
                            <tr class="filter">
                                ...
                                <td><?php echo $filter['customer_group_id']; ?></td>
                                <td><?php echo $filter['credit_limit']; ?></td>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <input type="checkbox" name="selected[]" value="<?php echo $result['customer_id']; ?>" checked="checked" />
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $result['customer_id']; ?>" />
                                    <?php } ?>
                                </td>
                                <td align="center">
                                ...
                                <td align="left"><?php echo $result['customer_group']; ?></td>
                                <td align="left"><?php echo $result['credit_limit']; ?></td>
