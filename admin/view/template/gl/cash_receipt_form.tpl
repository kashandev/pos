...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <label id="lblRefDoc"><?php echo $lang['ref_document_no']; ?></label>
...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive form-group">
            <table id="tblCashReceiptDetail" class="table table-striped table-bordered">
                <thead>
                <tr align="center">
                ...
                <?php foreach($cash_receipt_details as $detail): ?>
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <input type="hidden" name="cash_receipt_details[<?php echo $grid_row; ?>][ref_document_type_id]" id="cash_receipt_detail_ref_document_type_id_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_type_id']; ?>" />
                        <input type="hidden" name="cash_receipt_details[<?php echo $grid_row; ?>][ref_document_identity]" id="cash_receipt_detail_ref_document_identity_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_identity']; ?>" />
                    ...
                    <td style="width: 200px;">
                        ...
                        <select class="form-control select2" id="cash_receipt_detail_coa_id_<?php echo $grid_row; ?>" name="cash_receipt_details[<?php echo $grid_row; ?>][coa_id]">
                    ...
                    <td>
                        <input type="text" class="form-control" name="cash_receipt_details[<?php echo $grid_row; ?>][document_amount]" id="cash_receipt_detail_document_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['document_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control fDecimal" id="cash_receipt_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly/>
                    </td>
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="cash_receipt_details[<?php echo $grid_row; ?>][amount]" id="cash_receipt_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
                        <input onchange="calculateWHTAmount(this);" type="text" class="form-control fPDecimal" name="cash_receipt_details[<?php echo $grid_row; ?>][wht_percent]" id="cash_receipt_detail_wht_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateWHTPercent(this);" type="text" class="form-control fPDecimal" name="cash_receipt_details[<?php echo $grid_row; ?>][wht_amount]" id="cash_receipt_detail_wht_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_amount']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateOtherTaxAmount(this);" type="text" class="form-control fPDecimal" name="cash_receipt_details[<?php echo $grid_row; ?>][other_tax_percent]" id="cash_receipt_detail_other_tax_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateOtherTaxPercent(this);" type="text" class="form-control fPDecimal" name="cash_receipt_details[<?php echo $grid_row; ?>][other_tax_amount]" id="cash_receipt_detail_other_tax_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_amount']; ?>"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" name="cash_receipt_details[<?php echo $grid_row; ?>][net_amount]" id="cash_receipt_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" name="cash_receipt_details[<?php echo $grid_row; ?>][remarks]" id="cash_receipt_detail_remarks_<?php echo $grid_row; ?>" value="<?php echo $detail['remarks']; ?>" />
                    </td>
                    <td>
                        <a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>
                        <a title="Add" class="btn btn-xs btn-primary btnAddGrid" id="btnAddGrid" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
...
<script type="text/javascript" src="../admin/view/js/gl/cash_receipt.js"></script>
...
<script>
    ...
    var $partners = [];
    var $document_identity = '<?= $document_identity ?>';

   var $UrlGetPartnerJSON = '<?php echo $href_get_partner_json; ?>';

    <?php if($this->request->get['cash_receipt_id']): ?>
