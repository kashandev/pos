                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive form-group">
                                            <table id="tblBankPaymentDetail" class="table table-striped table-bordered">
                                                <thead>
                                                <tr align="center">
                                                ...
                                                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" id="bank_payment_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly="true"/>
                                                    </td>
                                                    <!-- <td>
                                                    ...
                                                    <td>
                                                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="bank_payment_details[<?php echo $grid_row; ?>][amount]" id="bank_payment_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                                                    </td>
                                                    <!-- <td>
                                                        <input onchange="calculateDicount(this);" type="text" class="form-control fDecimal" name="bank_payment_details[<?php echo $grid_row; ?>][discount_amount]" id="bank_payment_detail_discount_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['discount_amount']; ?>" />
                                                    </td> -->
                                                    <td>
