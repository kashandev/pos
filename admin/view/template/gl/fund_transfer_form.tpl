...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive form-group">
            <table id="tblFundTransferDetail" class="table table-striped table-bordered">
                <thead>
                <tr align="center">
                    ...
                    <td><?php echo $lang['to_account']; ?></td>
                ...
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td hidden>
                        <input type="text" class="form-control" id="fund_transfer_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly="true"/>
                    </td>
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="fund_transfer_details[<?php echo $grid_row; ?>][amount]" id="fund_transfer_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td hidden>
                    ...
                    <td hidden>
                        <input onchange="calculateWHTPercent(this);" type="text" class="form-control fPDecimal" name="fund_transfer_details[<?php echo $grid_row; ?>][wht_amount]" id="fund_transfer_detail_wht_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_amount']; ?>"/>
                    </td>
                    <td hidden>
                    ...
                    <td hidden>
                        <input onchange="calculateOtherTaxPercent(this);" type="text" class="form-control fPDecimal" name="fund_transfer_details[<?php echo $grid_row; ?>][other_tax_amount]" id="fund_transfer_detail_other_tax_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_amount']; ?>"/>
                    </td>
                    <td hidden>
                        <input type="text" class="form-control" name="fund_transfer_details[<?php echo $grid_row; ?>][net_amount]" id="fund_transfer_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>
                        <a title="Add" class="btn btn-xs btn-primary btnAddGrid" id="btnAddGrid" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
