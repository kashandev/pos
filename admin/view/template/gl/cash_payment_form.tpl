...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive form-group">
            <table id="tblCashPaymentDetail" class="table table-striped table-bordered">
                <thead>
                <tr align="center">
                ...
                <tbody>
                <?php $grid_row = 0; ?>
                <?php foreach($cash_payment_details as $detail): ?>
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td hidden>
                        <input type="hidden" name="cash_payment_details[<?php echo $grid_row; ?>][ref_document_type_id]" id="cash_payment_detail_ref_document_type_id_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_type_id']; ?>" />
                        <input type="hidden" name="cash_payment_details[<?php echo $grid_row; ?>][ref_document_identity]" id="cash_payment_detail_ref_document_identity_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_identity']; ?>" />
                        <a target="_blank" href="<?php echo $detail['href']; ?>"><?php echo $detail['ref_document_identity']; ?></a>
                    </td>
                    <td style="width: 200px;">
                        <select class="form-control select2" id="cash_payment_detail_coa_id_<?php echo $grid_row; ?>" name="cash_payment_details[<?php echo $grid_row; ?>][coa_id]">
                    ...
                    <td>
                        <input type="text" class="form-control" name="cash_payment_details[<?php echo $grid_row; ?>][remarks]" id="cash_payment_detail_remarks_<?php echo $grid_row; ?>" value="<?php echo $detail['remarks']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="cash_payment_details[<?php echo $grid_row; ?>][document_amount]" id="cash_payment_detail_document_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['document_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="cash_payment_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly="true"/>
                    </td>
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="cash_payment_details[<?php echo $grid_row; ?>][amount]" id="cash_payment_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
                        <input onchange="calculateWHTAmount(this);" type="text" class="form-control fPDecimal" name="cash_payment_details[<?php echo $grid_row; ?>][wht_percent]" id="cash_payment_detail_wht_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateWHTPercent(this);" type="text" class="form-control fPDecimal" name="cash_payment_details[<?php echo $grid_row; ?>][wht_amount]" id="cash_payment_detail_wht_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_amount']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateOtherTaxAmount(this);" type="text" class="form-control fPDecimal" name="cash_payment_details[<?php echo $grid_row; ?>][other_tax_percent]" id="cash_payment_detail_other_tax_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateOtherTaxPercent(this);" type="text" class="form-control fPDecimal" name="cash_payment_details[<?php echo $grid_row; ?>][other_tax_amount]" id="cash_payment_detail_other_tax_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_amount']; ?>"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" name="cash_payment_details[<?php echo $grid_row; ?>][net_amount]" id="cash_payment_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>
                        <a title="Add" class="btn btn-xs btn-primary btnAddGrid" id="btnAddGrid" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
...
<script type="text/javascript" src="../admin/view/js/gl/cash_payment.js"></script>
...
<script>
    ...
    <?php if($this->request->get['cash_payment_id']): ?>
