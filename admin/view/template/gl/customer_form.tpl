               ...
               <div class="panel-body">
                        ...
                        <label><?php echo $entry_industry; ?></label>
                            <select class="form-control" id="industry_id" name="industry_id" >
                                ...
                                <option value="<?php echo $id; ?>" <?php echo ($id == $industry_id ? 'selected="selected"' : ''); ?>>
                        ...
                        <label><?php echo $entry_customer_group; ?></label>
                            <select class="form-control" id="customer_group_id" name="customer_group_id" >
                                <?php foreach($customer_groups as $id => $value): ?>
                                <option value="<?php echo $id; ?>" <?php echo ($id == $customer_group_id ? 'selected="selected"' : ''); ?>><?php echo $value; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <?php echo $entry_credit_limit; ?> 
                            <input type="text" name="credit_limit" value="<?php echo $credit_limit; ?>" class="form-control"/>
                            <?php if (isset($error['credit_limit'])) { ?>
                            <span class="error"><?php echo $error['credit_limit']; ?></span>
                            <?php } ?>
                    </div>    
