...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <textarea name="remarks" value="<?php echo $remarks; ?>" class="form-control" rows="5"></textarea>
        </div>
    </div>
</div>
<div class="row hide">
...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive form-group">
            <table id="tblBankReceiptDetail" class="table table-striped table-bordered " style="width: 1920px">
                <thead>
                <tr align="center" class="tabletext">
                    <td><a id="btnAddGrid" title="Add" href="javascript:void(0);"><i class="fa fa-plus"></i></a></td>
                    ...
                    <td><?php echo $lang['current_amount']; ?></td>
                    <td><?php echo $lang['bank_amount']; ?></td>
                    ...
                    <td style="width: 15%;"><?php echo $lang['remarks']; ?></td>
                ...
                <tbody>
                <?php $grid_row = 0; ?>
                <?php foreach($bank_receipt_details as $detail): ?>
                <tr class="tabletext" id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <input type="hidden" name="bank_receipt_details[<?php echo $grid_row; ?>][ref_document_type_id]" id="bank_receipt_detail_ref_document_type_id_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_type_id']; ?>" />
                        <input type="hidden" name="bank_receipt_details[<?php echo $grid_row; ?>][ref_document_identity]" id="bank_receipt_detail_ref_document_identity_<?php echo $grid_row; ?>" value="<?php echo $detail['ref_document_identity']; ?>" />
                    ...
                    <td style="width: 200px;">
                        ...
                        <select class="form-control select2" id="bank_receipt_detail_coa_id_<?php echo $grid_row; ?>" name="bank_receipt_details[<?php echo $grid_row; ?>][coa_id]">
                    ...
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][document_amount]" id="bank_receipt_detail_document_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['document_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="bank_receipt_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly/>
                    </td>
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][amount]" id="bank_receipt_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][bank_amount]" id="bank_receipt_detail_bank_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['bank_amount']; ?>" readonly/>
                    </td>
                    <!-- <td>
                        <input onchange="calculateWHTAmount(this);" type="text" class="form-control fPDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][wht_percent]" id="bank_receipt_detail_wht_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateWHTPercent(this);" type="text" class="form-control fPDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][wht_amount]" id="bank_receipt_detail_wht_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['wht_amount']; ?>"/>
                    </td>
                    <td hidden="hidden">
                        <input onchange="calculateOtherTaxAmount(this);" type="text" class="form-control fPDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][other_tax_percent]" id="bank_receipt_detail_other_tax_percent_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_percent']; ?>"/>
                    </td>
                    <td>
                        <input onchange="calculateOtherTaxPercent(this);" type="text" class="form-control fPDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][other_tax_amount]" id="bank_receipt_detail_other_tax_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['other_tax_amount']; ?>"/>
                    </td> -->
                    <td>
                        <input type="text" class="form-control fDecimal" name="bank_receipt_details[<?php echo $grid_row; ?>][net_amount]" id="bank_receipt_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][remarks]" id="bank_receipt_detail_remarks_<?php echo $grid_row; ?>" value="<?php echo $detail['remarks']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][bank_name]" id="bank_receipt_detail_bank_name_<?php echo $grid_row; ?>" value="<?php echo $detail['bank_name']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control dtpDate" name="bank_receipt_details[<?php echo $grid_row; ?>][cheque_date]" id="bank_receipt_detail_cheque_date_<?php echo $grid_row; ?>" value="<?php echo $detail['cheque_date']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][cheque_no]" id="bank_receipt_detail_cheque_no_<?php echo $grid_row; ?>" value="<?php echo $detail['cheque_no']; ?>" />
                    </td>
...
<script type="text/javascript" src="../admin/view/js/gl/bank_receipt.js"></script>
...
<script>
    ...
    <?php if($this->request->get['bank_receipt_id']): ?>
