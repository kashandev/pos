                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="level2_code" name="level2_code" <?php echo($isEdit ? 'readonly="true"':'')?> value="<?php echo $level2_code; ?>" class="form-control fInteger"/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="table-responsive form-group" style="max-height: 200px;">
