...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive form-group">
            <table id="tblReceiptDetail" class="table table-striped table-bordered " style="width: 1920px">
                <thead>
                <tr align="center" class="tabletext">
                   ...
                   <!-- <td><?php echo $lang['ot_percent']; ?></td> -->
                    ...
                    <td><?php echo $lang['other_deduction']; ?></td>
                ...
                <tr class="tabletext" id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <input type="text" class="form-control" name="receipt_details[<?php echo $grid_row; ?>][document_amount]" id="receipt_detail_document_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['document_amount']; ?>" readonly="true"/>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="receipt_detail_balance_amount_<?php echo $grid_row; ?>" value="<?php echo ($detail['document_amount']-$detail['amount']); ?>" readonly/>
                    </td>
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control fDecimal" name="receipt_details[<?php echo $grid_row; ?>][amount]" id="receipt_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="receipt_details[<?php echo $grid_row; ?>][bank_amount]" id="receipt_detail_bank_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['bank_amount']; ?>" readonly/>
                    </td>
                    </td>
                    <!--<td>
                    ...
                    <td>
                        <input onchange="calculateOtherDeduction(this);"  type="text" class="form-control fPDecimal" name="receipt_details[<?php echo $grid_row; ?>][other_deduction_amount]" id="receipt_detail_other_deduction_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['other_deduction_amount']; ?>"/>
                    </td>  
                    <td>
                        <input type="text" class="form-control fDecimal" name="receipt_details[<?php echo $grid_row; ?>][net_amount]" id="receipt_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <!--<td>
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" id="other_deduction" name="total_other_deduction_amount" value="<?php echo $total_other_deduction_amount; ?>" class="form-control fDecimal" readonly="readonly" />
        </div>
    </div>
</div>
</form>
