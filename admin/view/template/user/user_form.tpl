                            ...
                            <form action="<?php echo $action_save; ?>" method="post" enctype="multipart/form-data" id="form">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="class_inline">
                                            <div class="form-group">
                                                <label><span class="required">*</span>&nbsp;<?php echo $lang['from_time']; ?></label>
                                                <input type="time" name="from_time" value="<?php echo $from_time; ?>" class="form-control"/>
                                            </div>
                                            <div class="form-group">
                                                <label><span class="required">*</span>&nbsp;<?php echo $lang['to_time']; ?></label>
                                                <input type="time" name="to_time" value="<?php echo $to_time; ?>" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
