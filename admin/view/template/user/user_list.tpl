                            ...
                            <form action="#" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <th align="center"><?php echo $lang['company']; ?></th>
                                        <?php endif; ?>
                                        <th align="center"><?php echo $lang['login_name']; ?></th>
                                        <th align="center"><?php echo $lang['user_name']; ?></th>
                                        <th align="center"><?php echo $lang['email']; ?></th>
                                        <th align="center"><?php echo $lang['created_at']; ?></th>
                                        <th align="center"><?php echo $lang['delete']; ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
